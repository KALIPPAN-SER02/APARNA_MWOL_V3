...
module.exports = {
    ...
    SESSION: process.env.APARNA_SESSION === undefined ? '' : process.env.PINKY_SESSION,
    AFN: process.env.ALL_CAPTION === undefined ? 'ᴍᴀᴅᴇ ʙy ᴋᴀʟɪᴩᴩᴀɴ ꜱᴇʀ' : process.env.ALL_CAPTION,
    ...
    APARNA_PM: process.env.APARNA_PM === undefined ? 'true' : process.env.APARNA_PM,
    CB: process.env.CALLER_BLOCK === undefined ? 'false' : process.env.CALLER_BLOCK,
    Z_APARNA_AI: process.env.Z_APARNA_AI === undefined ? 'false' : process.env.Z_APARNA_AI,
    ...
    AFNN: process.env.TAG_REPLY === undefined ? '918281370025@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOTCREATOR: "afnanplk",
    SUPPORT: "918281370025-1635775355",
